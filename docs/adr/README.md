...
| [010](./010-interactive-reader-tokenization.md) | Интерактивный ридер: токенизация и стратегия перевода | Принято | 2026-04-05 |
| [011](./011-translation-mymemory-api.md)        | Внешний сервис перевода: MyMemory API                 | Принято | 2026-04-05 |
| [012](./012-word-knowledge-level.md)            | Модель прогресса изучения слова: knowledgeLevel 0–5   | Принято | 2026-04-05 |
| [013](./013-design-system.md)                   | Дизайн-система: палитра Indigo, Geist, sidebar        | Принято | 2026-04-10 |
